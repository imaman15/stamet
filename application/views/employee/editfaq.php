    ...
    <div class="col-12">
        ...
        <div class="card shadow mb-3 animated zoomIn fast">
            <div class="card-body">
                ...
                <?= form_open(UE_MANAGEFAQ . UE_UPDATE . '/' . $faqs->faqs_id); ?>
                <div class="form-group">
                    <label for="">Judul Pertanyaan</label>
                    <input type="text" class="form-control <?= form_error('faqs_questions') ? 'is-invalid' : null ?>" value="<?= (set_value('faqs_questions')) ? set_value('faqs_questions') : $faqs->faqs_questions; ?>" name="faqs_questions" id="faqs_questions" placeholder="Judul Pertanyaan">
                    <div class="mb-1 mt-2">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="faqs_answers" id="faqs_answers" placeholder="Pesan"><?= (set_value('faqs_answers')) ? set_value('faqs_answers') : $faqs->faqs_answers; ?></textarea>
                ...
                <div class="custom-control custom-checkbox my-1 mr-sm-2">
                    <input type="checkbox" class="custom-control-input" name="status" id="status" value="1" <?= ($faqs->status == 1) ? "checked" : null; ?>>
